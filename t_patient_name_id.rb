...
class TC < Test::Unit::TestCase
  ...
  def test_name_id_05
    o = PatientNameID.new("./DicomFiles/Vitrea-20180713102058/DICOM/ST00001/SE00023/IM00003")
    assert_equal( {:fname=>"IM00003", :pid=>"Z1", :pname=>"EM", :study_date=>"20170316"}, o.name_id )
  end
end
